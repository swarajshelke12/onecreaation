...
// Fixed the typo in SVG filters tag feFeDisplacementMap -> feDisplacementMap
function feFeDisplacementMap(props: any) {
  return null; // fallback or we can just make sure SVG matches the user code exactly.
}
